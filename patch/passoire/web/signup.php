...
function hashPassword($password) {
    return password_hash($password, PASSWORD_ARGON2ID); # Changed Hash Function
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	// Add password list. Currently just the 1000 most common
	$commonPasswords = file('password_list.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
	...
	elseif (in_array($password, $commonPasswords)) {
		$error = "<p class=\"error\">Password is too common. Please choose another one.</p>";
	}
	else {
